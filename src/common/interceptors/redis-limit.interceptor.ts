...
import { REDIS_LIMIT_RANGE_SECOND_KEY, REDIS_LIMIT_KEY, REDIS_LIMIT_MAX_REQUEST_KEY } from '@src/constants';
import { RedisService } from '@src/plugin/redis/redis.service';
import { ToolsService } from '@src/plugin/tools/tools.service';
import { ICurrentUserType } from '../decorators';

type IRequest = Request & { user: ICurrentUserType };

@Injectable()
export class RedisLimitInterceptor implements NestInterceptor {
  constructor(private readonly redisService: RedisService, private readonly toolsService: ToolsService) {}
